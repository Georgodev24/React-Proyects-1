...
const Navbar = () => {
  return (
    <nav className='wrapped h-20 items-center flex justify-between'>
      ...
      <div className='fixed inset-0 bg-gradient-to-b from-white/70 to-black/70 translate-x-full z-40 peer-checked:translate-x-0 transition-transform md:static md:translate-x-0 md:bg-none'>
